 ...
 console.log("date:-", cdate);
  ...
  const getData = async (event) => {
    try {
      ...
      const res = await Axios.get(`http://localhost:8080/getcoursebydate/${cdate}/${teacherid}`)
      if (res.data !== "") {
  ...
  // console.log(courseData);
  //   console.log(courseData[0].course_id,courseData[0].course_category,courseData[0].course_start_time);
       ...
       />
          ...
          <div className="container ">
            ...
            <h3><strong>{teacherData.teacher_fname } { teacherData.teacher_lname}</strong></h3> */}
                    <div className='app' >
                      <h1 className='text-center'>Teacher Schedule</h1>
              ...
              <div className="col-lg-8">
                <div className="card shadow-sm">
                  <div className="card-header bg-transparent border-0">
                    <h3 className="mb-0"><i style={{ 'fontSize': '2em' }}></i >Date:{date.toDateString()} Running Course</h3>
                  </div>
                  ...
                  {/* { var list= myData.map((e,index) => return ( <table key={index} className="table table-bordered">
                      <tr>
                        <th width="30%">Course Name: JAVA</th>
                        <th width="30%">Time : 2:00 AM</th>
                        <th width="30%">End-date: 20-10-22</th>
                      </tr>
                      </table> ) } */}
                      {list}
