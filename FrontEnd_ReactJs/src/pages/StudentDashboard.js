...
export default function StudentDashboard() {
  ...
  const getLink = async (e) => {
    ...
    try {
      console.log(cid+"-----"+tid);
         ...
         var res = await axios.get(`http://localhost:8080/getlink/${cid}/${tid}`);
  ...
  function getCourses() {
    var cours = courses.map(element => {
       console.log("***********");
       console.log(element.course_teacher_id);
      ...
      return <tr key={element.course_id}>
        ...
        <a href={link1} target="_blank">Join the Class</a>
        </td>
                      ...
                      <table className="table m-0">
                        <thead>
                          <tr>
                            ...
                            <th scope="col">Today's Class Link</th>
