...
export default function TeacherDashboard() {
 ...
 const uplaodLink= async()=> {

  console.log(tid);
  try{
         
    const res = await axios.post("http://localhost:8080/uploadlinkinfo",{
      cid:cid,
      tid:tid,
      link:link
  ...
  <input type="text" class="form-control"  aria-label="Recipient's username" aria-describedby="basic-addon2" onChange={(e)=>{setLink(e.target.value)
  setTid(element.course_teacher_id);
  setCid(element.course_id);
  //setTid(element.course_teacher_id);
  
  }}/>
  <div class="input-group-append">
    <button class="btn btn-outline-secondary" type="button" onClick={uplaodLink}>Upload</button>
  </div>
</div></td>
              ...
              {/*<div class="col-lg-6 ">
                <div class="card">
                  ...
                  {/* style={{ 'height': '100%', 'width': '100%' }} */}
                    {/* <h2 class="card-title">Upload Class Link here</h2>
                    <center>
